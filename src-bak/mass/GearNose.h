 ...
 ******************************************************************************/
#ifndef MC_MASS_MASS_GEARNOSE_H_
#define MC_MASS_MASS_GEARNOSE_H_
...
public:
    ...
    static constexpr char kXmlTagName[] { "gear_nose" };     ///< component XML tag name
...
#endif // MC_MASS_MASS_GEARNOSE_H_
