 ...
 ******************************************************************************/
#ifndef MC_MASS_MASS_FUSELAGE_H_
#define MC_MASS_MASS_FUSELAGE_H_
...
public:
    ...
    static constexpr char kXmlTagName[] { "fuselage" };      ///< component XML tag name
...
#endif // MC_MASS_MASS_FUSELAGE_H_
