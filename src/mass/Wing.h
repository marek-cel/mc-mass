 ...
 ******************************************************************************/
#ifndef MC_MASS_MASS_WING_H_
#define MC_MASS_MASS_WING_H_
...
public:
    ...
    static constexpr char kXmlTagName[] { "wing" };          ///< component XML tag name
